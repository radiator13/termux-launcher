package com.termux.app.fragments.settings.termux_gui;
...
public class DebuggingPreferencesFragment extends MaterialPreferenceFragment {
    ...
    public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
        ...
        setPreferencesFromResource(R.xml.termux_gui_debugging_preferences, rootKey);
    ...
    private void configureLoggingPreferences(@NonNull Context context) {
        ...
        if (logLevelListPreference != null) {
            TermuxGUIAppSharedPreferences preferences = TermuxGUIAppSharedPreferences.build(context, true);
            if (preferences == null)
                return;
